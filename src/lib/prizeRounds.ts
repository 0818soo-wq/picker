...
export const PRIZE_ROUNDS: PrizeRound[] = [
  { rank: 5, label: "5등", prizeName: "삼성라이온즈 굿즈", count: 10, prizeImage: "/images/prizes/rank5-lions-goods.webp" },
  { rank: 4, label: "4등", prizeName: "배드민턴&탁구 선수단\n사인 유니폼", count: 12, prizeImage: "/images/prizes/rank4-jerseys.webp" },
